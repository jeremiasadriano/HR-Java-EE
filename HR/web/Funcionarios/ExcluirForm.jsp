<%-- Document : ExcluirFuncionario Created on : 08 Apr,2023, 01:29:49 Author :
mutizo --%> <%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    <form action="RemoverFuncionario.jsp" method="post">
      ...
      <div>
        ...
        <input type="text" id="idFunc" name="id"
      ...
      <div>
        ...
        <p id="txttelefone" name="telefone">
          <%=request.getParameter("telefone")%>
        </p>
      </div>
      <div>
        <label for="txtdepartamento">Departamento:</label>
        <input type="text" name="departamento" id="txttelefone" value="<%=
        request.getParameter("departamento")%>" required/>
      </div>
