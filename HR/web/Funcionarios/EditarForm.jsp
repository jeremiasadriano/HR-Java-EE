        ...
        <form action="EditarFuncionario.jsp" method="post" accept-charset="UTF-8">
            ...
            <div>
                ...
                <select id="txtdepartamento" name="departamento">
                    ...
                    <option value="<%= l.getNome_Departamento()%>" <% if (request.getParameter("departamento").equalsIgnoreCase(l.getNome_Departamento() )){ out.println("selected");}%>
                         >  <%= l.getNome_Departamento()%></option>
